...
public class GraphicUtils {
    ...
    public static TextButton createTextButtonAbsolute(String text, int x, int y, int width, int height, BitmapFont font, Color textColor, Color backgroundColor) {
    ...
    public static TextButton createTextButton(String text, int x, int y, int width, int height, BitmapFont font, Color textColor, Color backgroundColor) {
        TextButton.TextButtonStyle textButtonStyle = new TextButton.TextButtonStyle();
        textButtonStyle.font = font;
        textButtonStyle.font.getData().setScale(CoralSystemDeck.WORLD_WIDTH / Gdx.graphics.getWidth());

        textButtonStyle.fontColor = textColor;
        Pixmap pixmap = new Pixmap(Utils.toPixelsWidth(width), Utils.toPixelsHeight(height), Pixmap.Format.RGBA8888);
        pixmap.setColor(backgroundColor);
        pixmap.fill();
        textButtonStyle.up = new SpriteDrawable(new Sprite(new Texture(pixmap)));
        pixmap.dispose();
    ...
    public static Label createLabel(String text, CoralSystemDeck game, String fontName, Color color, float x, float y, float width) {
